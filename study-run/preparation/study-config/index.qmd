...
Sollen Aufgaben in Abhängigkeit der gegebenen Antworten angezeigt werden, muss dies stellenweise in der Testtaker-XML konfiguriert werden. Mehr dazu ist in [diesem](../adaptive/index.qmd) Kapitel zu finden.
...
Das soll an dieser Stelle erst einmal ausreichend sein. Es gäbe hier unzählige weitere individuelle Anforderungen an eine Studie, die eine bestimmte Struktur der Testhefte erfordern würden.
