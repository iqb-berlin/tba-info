...
::: {.callout-note}
Eine automatisch generierte Übersicht über die Elemente einer Testtaker-XML ist [hier](https://iqb.pages.cms.hu-berlin.de/testcenter/pages/testtaker.html) zu finden. Die Dokumentation optionaler Element ist ggf. separat dokumentiert.
:::
