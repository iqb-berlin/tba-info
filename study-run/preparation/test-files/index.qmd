...
Ein Test im Kontext des IQB-Testcenters ist die Gesamtheit aller Testinhalte, also eine konfigurierbare, strukturierte Sammlung von Aufgaben oder Fragen, die einer Testperson in einer bestimmten Reihenfolge präsentiert werden, um spezifische Informationen oder Leistungen zu erheben.
...
Es ist auch möglich, konditionale Unit-Blöcke zu definieren ([Adaptives Testen](../adaptive/index.qmd)). Die Entscheidung, welche Units der Testperson vorgelegt werden, ergibt sich aus den Antworten vorangegangener Units.
...
Die XML-Dateien Booklet, Testtaker und Unit werden gegen eine XML Schemadefinition validiert. Dies soll gewährleisten, dass fehlerhafte Inhalte bereits vor dem Laden in das Testcenter erkannt werden.

Weiter: [XML Validierung](validation.qmd)
