...
format:
  html:
    code-overflow: wrap
    other-links:
      - text: Schema-Definition Booklet-XML
        href: https://github.com/iqb-specifications/testcenter-booklet-xml/blob/main/testcenter-booklet-xml.xsd
      - text: Dokumentation Booklet-XML
        href: https://iqb-specifications.github.io/testcenter-booklet-xml/
      - text: Dokumentation der Booklet-Konfiguration
        href: https://iqb.pages.cms.hu-berlin.de/testcenter/pages/booklet-config.html
date: 2026-09-07
---
...
3. BookletConfig: Hier werden die Einstellungen für das Booklet vorgenommen. Die Liste der möglichen key-value-Paare ist oben rechts unter "weitere Links" zu finden.
...
::: {.callout-note}
Eine automatisch generierte Übersicht über die Elemente einer Booklet-XML ist [hier](https://iqb-specifications.github.io/testcenter-booklet-xml) zu finden.
:::

# Booklet-Einstellungen (BookletConfig)

Um die Erscheinung und das Verhalten des Booklets zu beeinflussen, gibt es eine Vielzahl von key-value- in `<BookletConfig>`. 
...
::: {.callout-note}
Eine vollständige Liste aller möglichen key-value-Paare, ist oben rechts unter "weitere Links" zu finden.
:::
