...
::: {.callout-note}
Eine automatisch generierte Übersicht über die Elemente einer Booklet-XML ist [hier](https://iqb.pages.cms.hu-berlin.de/testcenter/pages/booklet.html) zu finden. Die Dokumentation optionaler Element ist ggf. separat dokumentiert.
:::
...
Eine automatisch generierte Übersicht über die Elemente, Attribute und Werte für das adaptive Testen ist [hier](https://iqb.pages.cms.hu-berlin.de/testcenter/pages/adaptive-config.html) zu finden.
