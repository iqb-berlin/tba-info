...
Setzt die Anforderung bzgl. des zusätzlichen Navigations-Menüs mit der Möglichkeit der Testbeendigung um.
...
* `name`:<br>
Benutzername zum Start des Gruppenmonitors.
