...
An dieser Stelle soll eine kleine exemplarische Studie durchgeführt werden. Anwender\*innen sollen so ein besseres Gefühl für das Testcenter und die Studiendurchführung bekommen. 

::: {.callout-note}
Die Beispielstudie umfasst die folgenden Themenschwerpunkte:
...
* Die Begrüßungs-/ Verabschiedungsseite kann jederzeit rückwärts verlassen werden. Soll vorwärts navigiert werden, muss zuvor alles betrachtet werden. Da diese Seiten nur aus einer Textzeile bestehen, ist letztere Bedingungen quasi sofort erfüllt.
* Zur Navigation soll eine entsprechende Navigationsleiste mit den Nummern der Aufgaben angezeigt werden. Außerdem soll ein zusätzliches Aufgaben-Menü angezeigt werden.
