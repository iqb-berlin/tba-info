...
Es gibt da derzeitig keine Vorgaben seitens des IQB. Empfohlen werden die gängigen Browser, wie Google Chrome oder Firefox. **Mehr Information zu den Anforderungen an die Browser sind [hier](../preparation/required/school.qmd#software) zu finden.**
...
Editor-/ und Playerversion gehören immer zusammen. Bei der Aufgabenerstellung im Studio erzeugt der Editor eine Versionsnummer in der Unit-VOUD. Wird in der Unit-XML die angegebene Playerversion erhöht, ist es möglich diese höhere Version des Players zusammen mit der Aufgabe in das Testcenter zu laden. Beim Start des PLayers gleicht dieser aber seine Version mit der Version der Unit-VOUD ab. Gibt es hier eine Diskrepanz erscheint die Meldung, dass die Unit-Definition veraltet ist. Lösung: Soll ein neuerer Player verwendet werden, ist die Version im Studio für die jeweilige Aufgabe umzustellen und anschließend zu speichern. Im nächsten Schritt kann die Aufgabe exportiert werden und in das Testcenter geladen werden.
