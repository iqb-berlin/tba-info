...
* Die Steuerung eines Tests ist im Abschnitt [Testinhalte](test-files/index.qmd) ausführlich beschrieben.
* Im Abschnitt [Datenauswertung](eval/index.qmd) finden Sie Verfahren und Spezifikationen zum Download der Ergebnisse.
* Ein [System-Check](preparation/system-check/index.qmd) kann im Vorfeld der Testung mit dem Serversystem und der Schulhard- und -software durchgeführt werden, um Schwachstellen aufzudecken und mögliche Probleme bei der Durchführung zu vermeiden.
* Über eine spezielle Anmeldung kann die Testleitung einen [Gruppenmonitor](groupmon/index.qmd) aufrufen. Man kann darüber den Fortschritt jeder Testperson einer Gruppe beobachten. Man kann das Weiterleiten in andere Blöcke erzwingen, den Test pausieren, beenden oder sperren.
* Über eine [Schritt-für-Schritt-Anleitung](step-by-step/index.qmd) kann man gut den Arbeitszyklus verstehen.
