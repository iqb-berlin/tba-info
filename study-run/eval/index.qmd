...
Weitere Informationen zu den Programmierungen des IQB zur Kodierung finden Sie in dieser Dokumentation im [Bereich Studio](/tasks/coding-scheme) sowie separat [an dieser Stelle](https://iqb-berlin.github.io/coding-info/).
