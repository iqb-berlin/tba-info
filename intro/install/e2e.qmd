...
```
Der hier angegebene Parameter wird im Test: **nav-restrictions** im Verzeichnis **Test-Controller** getestet. Dazu stehen 3 Booklets im  Verzeichnis: **sampledata/system-test** zur Verfügung. Diese tragen die Namen: **CY_BKL_RestrictionNavValue1 - 3**.
