...
```
Der hier angegebene Parameter wird im Test: **time-restrictions** im Verzeichnis **Test-Controller** getestet. Dazu stehen 3 Booklets im  Verzeichnis: **sampledata/system-test** zur Verfügung. Diese tragen die Namen: **CY_BKL_TestletRestrictionParam_1** - **CY_BKL_TestletRestrictionParam_3**.
...
```
Der hier angegebene Parameter wird im Test: **navigation_restrictions** im Verzeichnis **Test-Controller** getestet. Dazu stehen 3 Booklets im  Verzeichnis: **sampledata/system-test** zur Verfügung. Diese tragen die Namen: **CY_BKL_TestletRestrictionParam_1 - 3**.
