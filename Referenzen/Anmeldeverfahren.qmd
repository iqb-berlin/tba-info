...
* Anmeldung mittels QR-Code einbringen

:::


::: {.callout-tip}
Für eine Testdurchführung erlaubt das IQB-Testcenter verschiedene Arten der Anmeldung (Logins) der Testperson. Die hier aufgeführten möglichen Anmeldungsvarianten werden in der XML zur Studien-Definition angelegt.
:::
