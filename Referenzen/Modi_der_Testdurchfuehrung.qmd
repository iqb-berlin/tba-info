...
Die Festlegung erfolgt in der **Testtaker-XML** im Element `Login` mit Hilfe des Attributs `mode` und eines zugehörigen Attributwertes. Nachfolgend ist ein einfaches Beispiel zu sehen:

::: {.callout-important}
Die Attributwerte des Attributs: `mode` sind nicht frei wählbar und sind einer entsprechenden Liste zu entnehmen. Hierbei ist die Groß-/Kleinschreibung zu beachten.
:::
...
::: {.callout-tip}
An dieser Stelle können nicht alle Funktionen der einzelnen Modi beschrieben werden. Eine Auflistung aller Funktionen ist [hier](https://pages.cms.hu-berlin.de/iqb/testcenter/pages/test-mode.html) zu finden!
:::