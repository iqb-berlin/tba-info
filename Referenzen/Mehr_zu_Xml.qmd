...
Um einen solchen sehr ungünstigen Zustand auszuschließen, ist im Testcenter eine **XML-Schema-Definition** hinterlegt. Die Schema-Definition definiert wie eine XML-Datei, die in das Testcenter geladen wird, auszusehen hat. Es handelt sich also um eine Art Vorlage. Wird eine XML-Datei in das Testcenter geladen, wird die Struktur der zu ladenden Datei mit der Vorlage abgeglichen. Bei Unstimmigkeit wird bereits beim Laden eine Fehlermeldung angezeigt, die auf diese Unstimmigkeiten hinweist. Dies verhindert zur Laufzeit Probleme beim Lesen einer XML-Datei.
