...
#### Wenn ich auf eine neue Version umstelle, erhalte ich die Fehlermeldung „Unit-Definition kann nicht geladen werden”. Was bedeutet das und was kann ich tun?

![](Unit_Definition_Grafik.png){width=600}

Manchmal erscheint diese Fehlemeldung in der Vorschau, wenn auf eine neue Studio-Version umgestellt wurde.

Dies lässt sich umgehen, wenn nach der Umstellung im Editor eine Änderung durchgeführt wird, d.h. zum Beispiel ein Objekt hinzugefügt wurde. Danach kann die Aufgabe abgespeichert werden und die Aufgabe ist auch in der neuen Version in der Vorschau zu sehen.
...
1.	Sie können das entsprechende Bild unkompliziert mit dem pixelbasierten Grafikprogramm GIMP skalieren, also in der Größe verändern. Eine detaillierte Anleitung inkl. Downloadlink (kostenfrei) finden Sie hier: [Bilder skalieren](../Aufgaben_gestalten/Externe_Anwendungen/Bilder_skalieren/index.qmd)
...
Trotz dieser Möglichkeit sollten die Grafiken auch skaliert werden, damit die Grafik-Datein nicht zu groß sind und langes Laden der Grafiken vermieden wird.
