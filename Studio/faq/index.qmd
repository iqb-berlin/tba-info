...
1.	Sie können das entsprechende Bild unkompliziert mit dem pixelbasierten Grafikprogramm GIMP skalieren, also in der Größe verändern. Eine detaillierte Anleitung inkl. Downloadlink (kostenfrei) finden Sie hier: [Bilder skalieren](../Externe_Anwendungen/Bilder_skalieren/index.qmd)
