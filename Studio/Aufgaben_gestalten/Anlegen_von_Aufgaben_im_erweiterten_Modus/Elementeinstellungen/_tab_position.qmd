...
Alle Elemente werden auf einem unsichtbaren Raster angezeigt. Jeder Abschnitt hat sein eigenes Raster (s. [Abschnittlayout](/Studio/Aufgaben_gestalten/Anlegen_von_Aufgaben_im_erweiterten_Modus/Abschnittseinstellungen/Abschnittseinstellungen.qmd)) bestehend aus Spalten und Zeilen. Jedem Element sollte eine Spalte und eine Zeile zugeordnet werden. Wenn ein neues Element erzeugt wird und dieses noch keiner Spalte und Zeile zugeordnet ist, sollte dies schnellstmöglich geändert werden.
