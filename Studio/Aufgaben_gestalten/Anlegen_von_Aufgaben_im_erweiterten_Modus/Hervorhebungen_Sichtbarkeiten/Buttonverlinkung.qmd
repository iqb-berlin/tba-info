...
Im Folgenden sehen sie ein ***Beispiel (Link einfügen)***, das aus den prototypischen Aufgaben des IQB-Studios stammt:
...
Sie können wie gewünscht in den Einstellungen beschriftet und eingefärbt werden. In dem gezeigten Beispiel ist die Beschriftung zum Beispiel „❯” und die Hintergrundfarbe „#ff0000”.
...
Nun erhält jeder Knop die Verknüpfung zur passenden Seite, beziehungsweise zum richtigen Abschnitt. 
