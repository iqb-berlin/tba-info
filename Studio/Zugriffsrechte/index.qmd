...
Bei der Installation des Studios werden System-Administrator\*innen eingerichtet. Nach der Anmeldung als System-Administrator\*in ist ein {{< fa gear >}} - Schalter für die System-Einstellungen im Kopf der Arbeitsbereichsliste zu sehen.
...
Es ist eine Liste aller Module für Editor, Schemer und PLayer zu sehen. Mit der {{< fa cloud >}} - Schaltfläche können neue Module geladen werden. Gelöscht können Module erst nachdem diese zuvor markiert wurden.
