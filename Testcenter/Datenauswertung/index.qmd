...
Die gegebenen Antworten werden mit einem Zeitstempel versehen in der Datenbank gespeichert. Das Testcenter speichert nicht bei jedem Tastendruck, aber nach einer kleinen Verzögerung zum Sammeln von Änderungen wird gespeichert. Sollte eine Unit erneut betreten werden (Neustart des Tests oder Zurückblättern), werden die Antworten wiederhergestellt.
...
| unitname | Textmarker |
| responses | {\"elementCodes\": \"[{\"id\":\"text_1\",\"value\":[\"468-659-#ffa06a\",\"1541-1617-#f9f871\",\"1617-1627-#9de8eb\",\"1627-1726-#f9f871\"],\"status\":\"VALUE_CHANGED\"},{\"id\":\"button_1\",\"status\":\"DISPLAYED\"},{\"id\":\"image_1\",\"value\":false,\"status\":\"DISPLAYED\"},{\"id\":\"checkbox_1\",\"value\":false,\"status\":\"DISPLAYED\"},{\"id\":\"checkbox_2\",\"value\":true,\"status\":\"VALUE_CHANGED\"},{\"id\":\"radio_1\",\"value\":1,\"status\":\"VALUE_CHANGED\"}]\"} |
...
Das Windows-Programm [itc-ToolBox](https://github.com/iqb-berlin/itc-toolbox/blob/master/docs/manual-output.md) liest die Antwort- und Logdaten entweder als CSV oder im direkten Zugriff auf eine IQB-Testcenter-Installation und erstellt eine Excel-Datei. Hier sind alle Antworten tabellarisch geordnet. Außerdem finden sich Daten zu time-on-page und zu den Systemparametern (Betriebssystem, Browser usw.) der Testsitzungen. Wenn die Daten über den Direktzugriff auf eine Testcenter-Installation eingelesen werden, greift die itc-ToolBox auch die Größenangaben der Testinhalte ab und liefert einen Indikator für die Download-Geschwindigkeit in kBytes/sec.
...
Weitere Informationen zu den Programmierungen des IQB zur Kodierung finden Sie in dieser Dokumentation im [Bereich Studio](/Studio/Kodierschema/) sowie separat [an dieser Stelle](https://iqb-berlin.github.io/coding-info/).
