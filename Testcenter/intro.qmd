...
Neu veröffentliche Browserversionen können unter Umständen Änderungen enthalten, die zu einem anderen Verhalten der Anwendung führen. Das IQB ist daher bemüht die Anwendung zeitnah in Verbindung mit Neuerscheinungen zu testen, kann dies aber nicht in jeden Fall gewährleisten, da die Vielzahl an möglichen neuen Browserversionen (Safari, Edge, Chrome, Firefox) recht herausfordernd ist. Sollten bereits neuere Versionen, als die hier genannten zum Einsatz kommen, empfiehlt sich die Voransicht einer geplanten Studie vor finalem Studienlauf. Hierfür bietet das Testcenter spezielle Modi der Studiendurchführung an, wie bspw. einen Review-Mode. Außerdem kann auch der **System-Check** verwendet werden. Ist von einem fehlerhaften Verhalten der Anwendung in Verbindung mit neueren Browserversionen auszugehen, kann ein entsprechender Hinweis über die Support-Adresse: [iqb-tbadev-support@hu-berlin.de](mailto:iqb-tbadev-support@hu-berlin.de) erfolgen.
