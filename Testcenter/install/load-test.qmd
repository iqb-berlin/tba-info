...
* Das Anlegen und dann wieder Löschen von 2.000 Logins entspricht dem realen Use Case, ist aber sehr aufwändig. Könnte ein Login im Modus `RUN-HOT-RESTART` hinreichend sein für die Ermittlung der Kapazität?
