...
* Funktionen, die mit der nächsten Hauptversion entfallen oder grundlegend überarbeitet werden, können in einem stabilen Release als `deprecated` markiert werden (Test des Releases).
