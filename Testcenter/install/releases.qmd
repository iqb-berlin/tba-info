...
* Die letzte Zahl nennt man **PATCH**, was soviel bedeutet wie Beheben eines Fehlers. Es gibt nur Änderungen, die dem mit MAJOR.MINOR erwartete Funktionieren des Systems sicherstellen. Dazu zählt auch der Austausch einer Komponente, die zwar nicht Teil der Programmierung ist, aber Teil der Auslieferung ist (z. B. treafik).
...
* Für die Prüfung des Installationsverfahrens kann es nötig sein, eine Vorabversion ohne Suffix zu veröffentlichen. Diese trägt dann nicht die Markierung `Pre-release`, aber auch nicht die Markierung `Latest`. Im Release-Text wird darauf hingewiesen, dass es sich nicht um eine stabile Version handelt.
...
* Einmal im Jahr am **1. März** wird eine Hauptversion veröffentlicht.
* Der Veröffentlichung der Hauptversion geht mindestens eine Vorabversion am **1. Februar** voraus. Dies kann eine `beta`- oder `rc`-Version sein.
...
* Termin: 1.3.2025
* Geplante Änderungen:
  - Das Testcenter kann in einer [Kubernetes](https://kubernetes.io/de/docs/concepts/overview/what-is-kubernetes/)-Umgebung eingesetzt werden. Dies führt zu Änderungen in der Auslieferung. Aus dem Backend-Container werden die Programmierungen für den Startup-Prozess extrahiert und in einen neuen Container platziert.
* Vorab-Version am 20.12.2024: Hier ist die Kubernetesfähigkeit grundsätzlich hergestellt (Gewährleistung der Ausfallsicherheit über mehrere Server hinweg), es können aber noch keine Container mehrfach gefahren werden
* Vorab-Version am 1.2.2025: Gewünschte Funktionsfähigkeit hergestellt, Testungen beginnen
...
* Vorab-Version am 1.12.2024: `beta` für die manuelle Erprobung

## Ausblick

* Für die nächste Hauptversion 17 am 1.3.2026 sind folgende Änderungen geplant:
