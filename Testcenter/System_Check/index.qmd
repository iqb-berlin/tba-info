...
```
1. Das Hochladen betrifft vor allem das Speichern der Antworten im Test. Parameter s. u.
2. Das Herunterladen betrifft vor allem die Testinhalte, also die Units und Testhefte zu Beginn der Testung. Parameter s. u.
...
```
1. `header` erzeugt eine Überschrift
2. `radio` erzeugt eine Auswahl. Die OPtionen sind mit `#` zu trennen
