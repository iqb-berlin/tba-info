...
* Die Konzentration auf die Funktion "Durchführung" ist wichtig, da die Tests und Befragungen des IQB und der Länder sehr große Zahlen an Testpersonen bewältigen müssen. Die Entwicklung der Testinhalte übernimmt eine andere Software [IQB-Studio](../Studio/index.qmd), und auch die Kodierung und Datenanalyse sind separat gelöst.
