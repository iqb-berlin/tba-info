...
Sowohl zur Studiendurchführung als auch zur Nutzung weiterer Funktionen des Testcenters, werden Dateien zur Konfiguration benötigt. Diese Dateien müssen in das Testcenter geladen werden. Das Testcenter stellt eine Reihe von Daten zur Studienauswertung bereit. Diese können aus dem Testcenter heruntergeladen werden. Mehr dazu ist dem gleichnamigen Kapitel zu entnehmen.
