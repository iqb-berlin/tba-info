...
* Ein [System-Check](system-check/index.qmd) kann im Vorfeld der Testung mit dem Serversystem und der Schulhard- und -software durchgeführt werden, um Schwachstellen aufzudecken und mögliche Probleme bei der Durchführung zu vermeiden.
...
* Über eine [Schritt-für-Schritt-Anleitung](test-run/step-by-step/index.qmd) kann man gut den Arbeitszyklus verstehen.
