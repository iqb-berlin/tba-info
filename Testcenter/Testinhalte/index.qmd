...
Für eine Testdurchführung ist mindestens ein Player notwendig. Es kann vorkommen, dass ein Player ein oder mehrere Basis-Pakete benötigt (s. o.). Ein Player ist eine Html-Datei und folgt der Verona-Spezifikation. Die Player des IQB [finden Sie hier]().
