...
Um den Upload zu vereinfachen, können auch **ZIP**-Dateien hochgeladen werden. Das IQB-Studio erzeugt auch den Aufgaben-Export als ZIP-Datei, der dann also direkt in den Testcenter-Arbeitsbereich geladen werden kann. Hier dauert die Prüfung der Validität eventuell länger, also bitte nicht ungeduldig werden!
