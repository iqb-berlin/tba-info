...
Unter dem Reiter: "Ergebnisse/Antworten" im Arbeitsbereich der Studie, können Antwortdaten heruntergeladen werden. Hier ist nun ein Datensatz mit dem Namen: "Teilnehmer Gruppe 1" zu finden. Der Name kommt aus der Studien-XML und entspricht dem Text im Attribut: `label` im Element: `Group`.
