...
Die Anmeldung erfolgt via festgelegter Zugangsdaten in der XML zur Studien-Definition und dem Schalter: "Weiter".
...
Der Startbildschirm mit der Testheftauswahl ist nur zu sehen, wenn mehrere Testhefte in der XML zur Studien-Definition angelegt sind. Gibt es mehrere Testhefte und werden diese nicht zur Auswahl angeboten: Eventuell besteht keine Internetverbindung. Es sollten entsprechende Routinen zur Fehlerbehebung beginnen (lose Kabel etc.).
