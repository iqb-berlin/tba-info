---
lang: de
title: Ratgeber Praxis
---

::: {.callout-note}
Um Durchführbarkeit und Stabilität einer Studie zu gewährleisten, wird empfohlen vor jeder finalen Studiendurchführung ausführliche Erprobungen durchzuführen.
:::
...
Ist die Testtaker-XML final konfiguriert (Festlegung Testmodus und Logins), kann sie in den Arbeitsbereich geladen werden. Anschließend sollte ein Probelauf der finalen Version gestartet werden. Hier kann vorab geprüft werden, ob sich alles wie geplant verhält und die Antwortdaten gespeichert werden. Wenn alles soweit in Ordnung ist, sollten die erzeugten Daten im Arbeitsbereich gelöscht werden, bevor die finale Studiendurchführung startet. Sonst sind später die Daten des Probelaufs im Datensatz der Studie enthalten.
