...
<Testtakers xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="https://raw.githubusercontent.com/iqb-berlin/testcenter/15.0.1/definitions/vo_Testtakers.xsd">
  ...
  <Group id="Gruppe1" label="Erste Gruppe">
    ...
    <Login mode="run-hot-return" name="Testperson 3" pw="wsds#">
        <Booklet>BOOKLET.SAMPLE-1</Booklet>
    </Login>
  </Group>
  <Group id="Gruppe2" label="Zweite Gruppe">
    ...
    <Login mode="run-hot-return" name="Testperson 6" pw="jkiu#">
        <Booklet>BOOKLET.SAMPLE-1</Booklet>
    </Login>
  </Group>
...
Testperson 1 meldet sich am Testcenter an und bearbeitet Aufgaben. Dann wird ein Datensatz mit dem Namen: **Erste Gruppe** erzeugt. Melden sich weiterhin Testperson 2 und Testperson 3 an, wird der vorhandene Datensatz um die gegebenen Antworten von Testperson 2 und Testperson 3 erweitert.

Melden sich Testperson 4, Testperson 5 oder Testperson 6 am Testcenter an, wird ein weiterer Datensatz mit dem Namen: **Zweite Gruppe** erzeugt.
