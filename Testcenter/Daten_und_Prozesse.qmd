...
* **individuelle Textersetzungen:**<br> Einzelne Texte der Anwendung können individuell an die eigene Bedürfnisse angepasst werden. Bspw. können Texte von Dialogfenster und Warnungen angepasst werden. Detaillierte Informationen zu den Textersetzungen sind den Referenzen zu entnehmen.
...
Eine weitere XML-Datei übernimmt die Testheft-Definition. Sie trägt IQB-intern den Namen **Booklet-XML**. Auch hier kann der Dateiname frei gewählt werden. Diese Datei ist oben im Bild mit "Test-Def" gekennzeichnet. Folgendes kann in dieser Datei festgelegt werden:
...
::: {.callout-note}
THuste
- Philipp nutzt doch nur die Variablen oder macht er noch etwas mit der VOCS-Datei?
:::
...
::: {.callout-note}
THuste
- Nutzt Philipp die Metadaten für irgedwas?
:::
...
Der Player wird in der XML zur Aufgaben-Definition eingebunden. Die aktuellen Versionen des jeweiligen Players sind in den entsprechenden GitHub-Repositories unter Releases zu finden und können dort heruntergeladen werden. Der in der XML zur Aufgaben-Definition festgelegte Player, muss dann mit in das Testcenter geladen werden. Zumeist handelt es sich um HTML-Dateien mit dem Namen des Players.

Das IQB hat verschiedene Player für unterschiedliche Aufgaben-Formate programmiert. Alle Player sind bei GitHub in entsprechenden Repositories veröffentlicht. Eine Übersicht finden Sie auf der [IQB-GitHub-Startseite](https://iqb-berlin.github.io)
