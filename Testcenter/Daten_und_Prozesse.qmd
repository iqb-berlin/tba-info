...
Die Testdateien können während des Aufgabenentwurfs vom **IQB-Studio** ausgegeben werden.

**Schritt 2:**

Es werden Dateien ausgegeben, die verschiedenen Funktionen zuzuordnen sind.

**Schritt 3:**

Die eigentliche Datei, die die in Schritt 2 genannte Funktion erfüllt. An dieser Stelle können die Dateien auch noch einmal bearbeitet und individuell angepasst werden, bevor sie in das Testcenter geladen werden. **Die Gesamtheit all dieser Dateien wird auch häufig als Testdateien bezeichnet.** 

**Schritt 4:**

Der Daten-Input erfolgt in den Arbeitsbereich der Studie.
...
```
Das Testcenter stellt zur Studienauswertung und zur Studienvorbereitung Daten zur Verfügung. Diese Daten können aus dem Testcenter heruntergeladen werden.
...
* System-Check Berichte: Diese können helfen abzuschätzen, ob die Studie in der gewünschten Umgebung hinsichtlich Ausstattung durchgeführt werden kann
