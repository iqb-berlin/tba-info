...
Das Feld **responses** wird in der folgenden JSON-Datenstruktur abgespeichert:
...
```
Das IQB hat hier Festlegungen getroffen, wie diese JSON aufgebaut sein soll, damit eine Auswertung erfolgen kann. Mehr dazu ist auf der [IQB-GitHub-Startseite](https://iqb-berlin.github.io/) unter **Spezifikationen: Antworten** zu finden.
