...
Die eigentliche Hardware der Endgeräte spielt bzgl. der Stabilität eines Studienlaufs eine untergeordnete Rolle, da für die Anwendung ehr der Browser entscheidend ist. Durchaus interessant könnte es aber sein, welche Bildschirmgrößen mit welchen Auflösungen zum Einsatz kommen werden. Die Aufgabeninhalte verhalten sich zwar responsive, dennoch kann es sinnvoll sein Aufgaben bzgl. der Darstellung zu optimieren. Kommen bspw. größtenteils kleinere Tablets zum Einsatz, kann es sinnvoll sein, Aufgaben bestehend aus mehreren Seiten zu vermeiden, weil die Seiteninhalte dann nur noch entsprechend klein dargestellt werden können. Die Frage nach den zum Einsatz kommenden Endgeräten sollte sich also nicht erst kurz vor der eigentlichen Studiendurchführung mit dem Testcenter stellen, sondern bereits bei der Aufgabenentwicklung. Da es sich um eine Webanwendung handelt, muss das Endgerät über eine Verbindungsmöglichkeit zum Internet verfügen.
...
::: {.callout-important}
Veraltete oder nicht unterstütze Browser können zu unerwartetem Verhalten während der Studie führen! Im schlimmsten Fall ist einen Studie dann nicht wie vorgesehen durchführbar.
:::
