...
Dieser Personenkreis erhält die Zugangsdaten durch eine spezielle XML-Datei (XML zur Studien-Definition), die in den Arbeitsbereich der Studie geladen wird. Meldet sich eine Testperson mit den in dieser XML hinterlegten Zugangsdaten am Testcenter an, wird ein vorgesehenes Testheft gestartet und die enthaltenen Aufgaben werden präsentiert. Mit anderen Worten: Es wird ein Test gestartet.
...
Sobald eine Datei hochgeladen ist, ist sie wirksam. D. h. unmittelbar nachdem eine Datei mit Zugangsdaten (XML zur Studien-Definition) hochgeladen wurde, kann sich eine Testperson mit diesen Zugangsdaten anmelden. Sollte man feststellen, dass eine Aufgabe Fehler enthält, kann man die Datei zur Aufgabe überarbeiten und erneut in das Testcenter laden. Jeder danach gestartete Test, wird dann die neue Aufgabe verwenden.

::: {.callout-note}
Weitere Infos zum Laden von Testdateien sind dem Kapitel: **Daten und Prozesse/ Daten Upload** zu entnehmen.
:::
