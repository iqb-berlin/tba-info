...
{{< downloadthis assets/Logins-Vorlage1.docx label="Beispiel-Vorlage 1 - ohne QR-Codes" dname="Docx-Datei: Alle Daten werden ausgegeben außer der QR-Code des Links." icon=filetype-docx >}}
