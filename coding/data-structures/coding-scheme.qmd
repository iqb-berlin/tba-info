...
* Ausführliche Erläuterungen der Nutzung des Schemas (Kodierung) finden Sie demnächst [hier](../../tasks/coding-scheme/index.qmd).
...
Wenn der Code zutrifft, wird auch stets der Parameter `score` der [Antwortdaten](response.qmd) gesetzt. Es handelt sich um einen numerischen ganzahligen Wert.
