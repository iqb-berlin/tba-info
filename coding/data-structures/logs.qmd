...
::: {.callout-tip}
Welche Bedeutung die Werte eines Logeintrags haben, ist auch [**hier**](https://github.com/iqb-berlin/testcenter/blob/master/docs/pages/logging.md) noch einmal beschrieben.
:::
