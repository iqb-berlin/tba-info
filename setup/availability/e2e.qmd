...
4. Terminal öffnen und die folgenden Befehle nacheinander eingeben: `make init`, `make build` und abschließend `make test-system`. Wenn alles erfolgreich ausgeführt, öffnet sich die Cypress Oberfläche.
5. "E2E Testing" in der Cypress Oberfläche auswählen
6. Browser auswählen
7. Testfall wählen und Test starten
