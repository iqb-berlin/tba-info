...
## Hinweis
 ...
 Die Wörter müssen hierfür nicht einzeln durchgezählt werden. Im Reiter Vorschau kann auch der Bereich markiert werden und "Kodierung prüfen" ausgewählt werden, so wie in Abschnitt [-@sec-Markieren]. Die erste Zahl des angezeigten Code ist die Zahl des ersten Wortes des Bereiches und die zweite Zahl ist die Zahl des letzten Wortes. So kann man die einzutragenden Zahlen auch ablesen.
