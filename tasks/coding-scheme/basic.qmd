---
lang: de
title: "Kodierung einzelner Formate"
lightbox: true
---
...
* Beim Anlegen der Kodierung bei Aufgaben mit Drag-und-Drop-Format ist die Benennung der IDs komplex.
    ...
    Hier gibt es einen Sonderfall, der von diesem Verfahren abweicht. Wenn jedes Element seperat bewertet wird, dann werden die Ablagelisten unabhängig voneinander und als seperate Items benannt. Es werden also die IDs `01`, `02`, `03`, usw. vergeben. Diese werden dann auch nicht zu einer ID abgeleitet.
...
Dieses Verfahren gilt nur, wenn **alle** Bereiche markiert werden müssen, damit das Item als richtig gewertet wird. Bei Bereichen, die optional markiert werden dürfen, ist die Kodierung etwas anders und wird im Abschnitt [-@sec-Markieren_optional] beschrieben.
