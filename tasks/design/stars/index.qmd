...
* [Allgemeine Parameter](root-parameters.qmd) (Hintergrund, Haupt-Audio, Weiter-Button)
* Interaktionstypen: Über den Parameter `interactionType` wird ein bestimmtes Unit-Modell festgelegt, das dann über weitere Parameter genauer spezifiziert wird
