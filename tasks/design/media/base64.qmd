...
Es öffnet sich ein Kommando-Fenster. Hier gibt man ein `.\base64-generator.ps1` (siehe folgendes Bild).

![](base64_1.png)

Man kann auf dieser Basis auch Parameter an das Script übergeben. Als erster Parameter wird das Verzeichnis erwartet, in dem sich die Mediendateien befinden. Als zweiter Parameter kann der Name der Datei übergeben werden, in der dann die Base64-Strings gespeichert sind. Auf diese Art kann sich der Ort der Scriptdatei vom Ort der Mediendateien unterscheiden.
