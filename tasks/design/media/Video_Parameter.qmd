...
::: {.callout-warning}
## Safe Exam Browser
Die Empfehlung unten enthält einen lizenzpflichtigen Codec, der eine breite Palette an Browsern und Betriebsssystemen abdeckt. Der Safe Exam Browser kann lizenzpflichtige Codecs jedoch nicht abspielen.
:::
