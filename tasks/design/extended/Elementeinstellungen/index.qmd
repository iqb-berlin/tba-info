...
![](Grafiken/elementeinstellungen_gesamt.png)
...
## ![](Grafiken/elementeinstellungen_symbol.png) Elementspezifische Einstellungen

In diesem Tab gibt es diverse Einstellungen für die Funktionalität der Elemente im Studio. Die meisten davon sind spezifisch zu den einzelnen Elementen. Die folgenden Einstellungen sind allen Elementen gemeinsam. Oben ist exemplarisch der Elementeinstellungstab eines Textelements abgebildet.
...
Wenn Sie den Haken bei „Elementinteraktion erlauben“ setzen, können Sie im Editor mit dem Element interagieren, also beispielsweise bei Optionsfeldern Optionen auswählen. Im Allgemeinen wird aber empfohlen, die Aufgabe in der Vorschau anzusehen, da dies näher an der Darstellung im Testcenter ist.
...
## ![](Grafiken/position_symbol.png) Position und Maße
...
## ![](Grafiken/gestaltung_symbol.png) Gestaltung

![](Grafiken/gestaltung_gesamt.png)
...
Hier können Sie Einstellungen zur Formatierung des Textes im Element vornehmen. Normalerweise sollte hier nichts geändert werden, stattdessen können Sie den Texteditor des Studios verwenden. Es kann aber vorkommen, dass für die genaue Positionierung des Textes eine Änderung der Zeilenhöhe nötig ist, was nur in den Einstellungen des Elements möglich ist.
