...
Alle Elemente werden auf einem unsichtbaren Raster angezeigt. Jeder Abschnitt hat sein eigenes Raster (s. [Abschnittlayout](/tasks/design/extended/Abschnittseinstellungen/Abschnittseinstellungen.qmd)) bestehend aus Spalten und Zeilen. Jedem Element sollte eine Spalte und eine Zeile zugeordnet werden. Wenn ein neues Element erzeugt wird und dieses noch keiner Spalte und Zeile zugeordnet ist, sollte dies schnellstmöglich geändert werden.
