...
Im erweiterten Modus können Sie den Text innerhalb des Elements in mehrere Spalten teilen. Im Texteditor wird der Text dann anteilig auf die eingestellte Anzahl Spalten aufgeteilt. Alternativ können Sie aber auch im Raster weitere Spalten mit neuen Textelementen hinzufügen. Weitere Informationen zu Raster finden Sie [hier](../Abschnittseinstellungen/index.qmd#layout).
