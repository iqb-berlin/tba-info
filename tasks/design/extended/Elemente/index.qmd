...
Im erweiterten Modus können Sie den Text innerhalb des Elements in mehrere Spalten zu teilen. Man sollte abwägen ob dies besser ist, als im Raster des Abschnitts eine weitere Spalte mit einem eigenen Textelement hinzuzufügen.
...
Wird die Option „Zeige gewählten Wert“ ausgewählt, sieht man beim Bewegen des Punktes des aktuellen Wert als Tooltip.
...
Wenn die Ablegeliste als Sortierliste funktionieren soll, gibt es einen Kasten zum Ankreuzen dafür in den elementspezifischen Einstellungen. 
...
Das Element Textmarkierung funktioniert ähnlich wie die Markierfunktion, die Textelementen hinzugefügt werden kann, nur können Sie ein Textmarkierungselement frei bewegen.
