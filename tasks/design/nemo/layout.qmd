...
Die Position von Elementen kann dann auch vertikal bestimmt werden. Das bedeutet, dass als Positionierung "unten" zur Verfügung steht. Das Layout im StarS-Bereich sieht meist vor, Elemente vertikal und horizontal zu zentrieren.
...
::: {.callout-note}
Das Verhalten und die Anzeige des Weiter-Buttons wird ggf. auch durch den Abschnitt [feedback](feedback.qmd) beeinflusst.
:::