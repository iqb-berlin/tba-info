...
::: {.callout-note}
## Hinweis Breechtigung
Die folgenden Funktionen können nur mit der Berechtigung "Vollzugriff" in einem Arbeitsbereich genutzt werden.
:::

# Vorlagen benutzen

Eine sinnvolle Arbeitsweise zu Beginn einer Aufgabenentwicklung kann es sein, bereits fertige Aufgaben zu kopieren. Das Konzept der "Vorlage" sieht eine Sammlung typischer Aufgabenformte vor, die nur Platzhalter als Bild oder Text enthalten (z. B. "Hier Option eintragen"). Für eine neue Aufgabe nimmt man dann eine passende Vorlage, kopiert sie in eine neue Aufgabe und ändert schrittweise die Platzhalter.
